...
\subsection{Rigid body modelling} \label{stateslbl}
...
\subsubsection{Collision resolution}\label{reslbl}
...
\label{bboxfig}
\begin{center}
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{figs/Bounding_box.png}}
  \end{center}
...
\begin{figure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[width=\textwidth]{figs/img5.png}}
      \end{center}
    \caption{Segments}
\end{figure}
...
\section{Quantitative evaluations} \ref{explbl}
...
\begin{figure} \label{ev3}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[width=\textwidth]{figs/p3.png}}
      \end{center}
    \end{figure}
